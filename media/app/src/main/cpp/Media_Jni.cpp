...
Java_cn_fabric_media_MediaJni_init(JNIEnv *env, jclass type, jstring url_, jint w, jint h,
                                         jint timeOut) {
...
Java_cn_fabric_media_MediaJni_sendSpsAndPps(JNIEnv *env, jclass type, jlong cptr,
...
JNIEXPORT jint JNICALL
Java_cn_fabric_media_MediaJni_sendVideoData(JNIEnv *env, jclass type, jlong cptr,
...
JNIEXPORT jint JNICALL
Java_cn_fabric_media_MediaJni_sendAacSpec(JNIEnv *env, jclass type, jlong cptr,
...
JNIEXPORT jint JNICALL
Java_cn_fabric_media_MediaJni_sendAacData(JNIEnv *env, jclass type, jlong cptr,
                                                jbyteArray data_, jint len, jlong timestamp) {
    jbyte *data = env->GetByteArrayElements(data_, NULL);
...
JNIEXPORT jint JNICALL
Java_cn_fabric_media_MediaJni_stop(JNIEnv *env, jclass type, jlong cptr) {
    Rtmp *rtmp = reinterpret_cast<Rtmp *> (cptr);
    delete rtmp;
    return 0;
}
