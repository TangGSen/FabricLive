...
import cn.fabric.media.Config;
import cn.fabric.media.MediaPublisher;
...
public class CameraActivity extends AppCompatActivity implements SurfaceHolder.Callback2 {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.fabric.live.R.layout.activity_camera);
        Log.i(TAG, "onCreate: ");
        initView();
    ...
    private void initView() {
        mSurfaceView = (SurfaceView) findViewById(com.fabric.live.R.id.surface_view);
    ...
    public void surfaceChanged(SurfaceHolder holder, int format, int width, int height) {
        ...
        mMediaPublisher.initVideoGatherer(CameraActivity.this, holder,cameraId);
    }
